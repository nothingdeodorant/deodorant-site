...
function ProductMockup({ dark = false }: { dark?: boolean }) {
  return (
    <motion.div
      ...
      className={`relative h-[520px] w-[280px] rounded-[3rem] border shadow-2xl ${
        dark
    ...
    >
      <div className="absolute inset-x-10 top-12 text-center">
        <div className="text-3xl font-semibold tracking-[0.15em]">NOTHING</div>
        <div
        ...
        <div className={`mt-6 text-sm ${dark ? "text-white/70" : "text-black/70"}`}>
          Smell like nothing.
        </div>
      </div>

      <div
        className={`absolute inset-x-8 bottom-20 space-y-2 text-center text-xs uppercase tracking-[0.22em] ${
      ...
      <div
        className={`absolute inset-x-10 bottom-8 h-10 rounded-2xl ${
      ...
      <header className="sticky top-0 z-30 border-b border-black/10 bg-white/90 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-6 px-6 py-4 md:px-10 lg:px-12">
          ...
          <div className="hidden md:block">
            <PrimaryButton onClick={() => setCurrentPage("Shop")}>Join Waitlist</PrimaryButton>
          </div>
        </div>
      ...
      <footer className="border-t border-black/10 bg-neutral-50">
        <div className="mx-auto grid max-w-7xl gap-10 px-6 py-14 md:grid-cols-4 md:px-10 lg:px-12">
          <div className="md:col-span-2">
            <div className="text-2xl font-semibold tracking-[0.18em]">NOTHING</div>
          ...
          <div>
            ...
            <button
              ...
              className="mt-4 text-left text-sm leading-7 text-black/65 transition hover:text-black"
            >
  ...
  return (
    <>
      <section className="border-b border-black/10">
        <div className="mx-auto grid max-w-7xl gap-12 px-6 py-20 md:grid-cols-2 md:px-10 lg:px-12 lg:py-28">
          <div className="flex flex-col justify-center">
            <div className="mb-5 inline-flex w-fit rounded-full border border-black px-3 py-1 text-xs tracking-[0.35em] uppercase">
              Fragrance-Free Deodorant
            </div>

            <h1 className="text-6xl font-semibold tracking-tight md:text-7xl">NOTHING</h1>

            <p className="mt-6 text-lg font-medium text-black/80">
              Deodorant that does one job: eliminate odor.
            </p>

            <p className="mt-8 max-w-xl text-xl leading-8 text-black/80">{taglines[0]}</p>

            <p className="mt-6 max-w-xl text-base leading-8 text-black/70">
              Most deodorants try to make you smell like something.
              <br />
              <br />
              Ocean breeze. Midnight musk. Bourbon leather.
              <br />
              <br />
              We do not.
              <br />
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <PrimaryButton onClick={() => setCurrentPage("Shop")}>Join Early Access</PrimaryButton>
              <button
                type="button"
                onClick={() => setCurrentPage("How It Works")}
                className="rounded-2xl border border-black px-7 py-3 text-sm font-medium transition hover:bg-black hover:text-white"
              >
                See How It Works
              </button>
            </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 md:px-10 lg:px-12">
        <div className="mb-14 rounded-[2rem] border border-black/10 bg-neutral-50 p-8 md:p-10">
          <SectionEyebrow>The biggest opportunity</SectionEyebrow>
        ...
        <div className="mb-14 grid grid-cols-2 gap-4 md:grid-cols-4">
          {["Aluminum Free", "Fragrance Free", "Minimal Ingredients", "Gender Neutral"].map((item) => (
            <div
              key={item}
              className="rounded-2xl border border-black/10 bg-neutral-50 px-5 py-4 text-center text-sm font-medium"
            >
              {item}
            </div>
          ))}
        ...
        <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr]">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-base leading-8 text-black/70">
              Walk down the deodorant aisle and you will see dozens of products trying to make you smell like something.
              <br />
              <br />
              Coconut vanilla. Lavender sage. Mahogany teakwood.
              <br />
              <br />
              But a growing number of people are tired of artificial fragrance.
              <br />
              <br />
              They want something radically simple:
              <br />
              <br />
              <b>No odor. No scent. No nonsense.</b>
            </p>
          </div>

          <div className="grid gap-4 sm:grid-cols-2">
            {features.map((feature) => (
              <div key={feature} className="rounded-3xl border border-black/10 p-6 shadow-sm">
      ...
      <section className="border-y border-black/10 bg-black text-white">
        <div className="mx-auto max-w-7xl px-6 py-20 md:px-10 lg:px-12">
          <SectionEyebrow light>Why It Works</SectionEyebrow>
          ...
          <p className="mt-6 max-w-3xl text-base leading-8 text-white/75">
            ...
            <br />
            <br />
            Body odor happens when bacteria break sweat down into odor-producing compounds.
            <br />
            <br />
            Nothing targets that process directly with aluminum-free ingredients chosen specifically for odor neutralization.
          </p>

          <div className="mt-12 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
            {ingredients.map((item) => (
              <div key={item.name} className="rounded-3xl border border-white/15 bg-white/5 p-6">
                <div className="text-lg font-medium">{item.name}</div>
                <p className="mt-3 text-sm leading-7 text-white/70">{item.role}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 md:px-10 lg:px-12">
        <div className="rounded-[2rem] border border-black/10 bg-neutral-50 p-8 md:p-10">
          <SectionEyebrow>Why this brand is memorable</SectionEyebrow>
          <h2 className="mt-4 text-3xl font-semibold tracking-tight md:text-5xl">
        ...
        <div className="mt-16 flex items-end justify-between gap-8">
          <div>
            <SectionEyebrow>Taglines</SectionEyebrow>
      ...
      <section className="border-t border-black/10 bg-neutral-50">
        <div className="mx-auto max-w-7xl px-6 pt-16 md:px-10 lg:px-12">
          <div className="mt-0">
            <SectionEyebrow>Why this spreads</SectionEyebrow>
            <h2 className="mt-4 text-3xl font-semibold tracking-tight md:text-5xl">
    ...
    <div className="mx-auto max-w-7xl px-6 py-16 md:px-10 lg:px-12 lg:py-20">
      <div className="grid gap-12 lg:grid-cols-[0.95fr_1.05fr]">
        ...
        <div className="flex flex-col justify-center">
          ...
          <h1 className="mt-4 text-4xl font-semibold tracking-tight md:text-6xl">Nothing Deodorant Stick</h1>
          ...
          <p className="mt-6 max-w-2xl text-base leading-8 text-black/70">
            A radically simple deodorant built to neutralize body odor without adding fragrance.
            <br />
            <br />
            No cedar. No musk. No ocean breeze.
            <br />
            <br />
            Just clean, effective daily odor protection for people who want to smell like nothing.
          </p>

          <div className="mt-8 space-y-3">
            {bullets.map((bullet) => (
              <div key={bullet} className="rounded-2xl border border-black/10 px-4 py-3 text-sm text-black/75">
                {bullet}
              </div>
            ))}
          </div>
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2">
            ...
            >
              ...
              <button className="mt-6 w-full rounded-2xl bg-black px-6 py-3 text-sm font-medium text-white transition hover:opacity-90">
                Preorder 1 Stick
              </button>
            </button>
  ...
  return (
    <>
      ...
      <section className="border-y border-black/10 bg-neutral-50">
        <div className="mx-auto max-w-5xl px-6 py-16 md:px-10 lg:px-12 lg:py-20">
          ...
          <div className="mt-6 rounded-[2rem] border border-black/10 bg-white p-10">
            ...
            <p className="mt-6 text-lg leading-8 text-black/80">
              I went on a playful rant with a co-worker about how ridiculous it is that all these deodorants try to make you smell like something.
            </p>

            <p className="mt-6 text-lg leading-8 text-black/80">Not fresh. Not clean. Something.</p>

            <p className="mt-6 text-lg leading-8 text-black/80">
              When in reality, most people just want one thing:
            </p>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 md:px-10 lg:px-12 lg:py-20">
        <div className="grid gap-6 md:grid-cols-2">
          {[
            ["The mission", "Eliminate odor. Add nothing."],
            ["The wedge", "Own the anti-fragrance position in deodorant."],
          ].map(([title, body]) => (
            <div key={title} className="rounded-[2rem] border border-black/10 bg-white p-8">
              <div className="text-xl font-semibold tracking-tight">{title}</div>
              <p className="mt-4 text-base leading-8 text-black/70">{body}</p>
            </div>
          ))}
        </div>
      </section>
